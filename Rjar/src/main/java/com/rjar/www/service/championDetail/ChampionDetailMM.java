...
public class ChampionDetailMM {
   ...
   public ModelAndView counterInfo(String championName, String lane, String tier, int championId) {
      mav = new ModelAndView();
   ...
   public List<Reply> replyUpdate(Reply reply) {
      ...
      public ModelAndView itemInfo(String championName, String lane, String tier, int championId) {
            mav = new ModelAndView();
