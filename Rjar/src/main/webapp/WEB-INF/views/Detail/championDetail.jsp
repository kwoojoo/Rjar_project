...
<div id="nav">
       <nav>
          <ul style="list-style: none; margin: 0px;">
             <li>
                <form action="clickDetail" method="get">
                  ...
                  <input type="hidden" value="${championId}" name="championId">
                  <button class="btn">
...
<div id="build_box">
   ...
   <div id="spell_start_box">
      ...
      <div id="skill_box">
         <div id="skill_text">
            <br style="size:3px">
            <font style="font-size: 24px">스킬 빌드</font>
         </div>
         <div id="skill_build_img">
         	<img id="master_img1" src="https://ddragon.leagueoflegends.com/cdn/12.15.1/img/spell/${master1}">
         	<div class="next"><font size="5px">▶</font></div>
         	<img id="master_img2" src="https://ddragon.leagueoflegends.com/cdn/12.15.1/img/spell/${master2}">
         	<div class="next"><font size="5px">▶</font></div>
         	<img id="master_img3" src="https://ddragon.leagueoflegends.com/cdn/12.15.1/img/spell/${master3}">
         </div>
         ...
         <div id="skill_win_cnt">
            <div style="position: absolute; margin-left: 800px; margin-top: 130px;">
            	${skill1.skill_winrate}% <br>
            	${skill1.skill_cnt}게임
            </div>
         </div>
     </div> <!-- end skill_box -->
